...
function cordentro1(){
    alt1.style.background = '#FFD700';
}

function cordentro2(){
    alt2.style.background = '#FFD700';
}

function cordentro3(){
    alt3.style.background = '#FFD700';
}

function cordentro4(){
    alt4.style.background = '#FFD700';
}

function corfora1(){
    alt1.style.background = '#f3bf2e';
}

function corfora2(){
    alt2.style.background = '#f3bf2e';
}

function corfora3(){
    alt3.style.background = '#f3bf2e';
}

function corfora4(){
    alt4.style.background = '#f3bf2e';
}
